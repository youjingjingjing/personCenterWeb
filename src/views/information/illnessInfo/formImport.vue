...
<script lang="ts" setup>
  ...
  import { illnessInfoImportData } from '/@/api/information/illnessInfo';
  ...
  async function handleDownloadTemplate() {
    ...
    downloadByUrl({ url: ctxAdminPath + '/information/illnessInfo/importTemplate' });
  }
  ...
  async function handleSubmit() {
    try {
      ...
      const { data } = await illnessInfoImportData(params, onUploadProgress);
