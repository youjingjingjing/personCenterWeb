...
<script lang="ts" setup>
  ...
  import { basicInformationImportData } from '/@/api/information/basicInformation';
  ...
  async function handleDownloadTemplate() {
    ...
    downloadByUrl({ url: ctxAdminPath + '/information/basicInformation/importTemplate' });
  }
  ...
  async function handleSubmit() {
    try {
      ...
      const { data } = await basicInformationImportData(params, onUploadProgress);
