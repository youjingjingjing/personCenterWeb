...
<script lang="ts" setup>
  ...
  import { dailySignsImportData } from '/@/api/information/dailySigns';
  ...
  async function handleDownloadTemplate() {
    ...
    downloadByUrl({ url: ctxAdminPath + '/information/dailySigns/importTemplate' });
  }
  ...
  async function handleSubmit() {
    try {
      ...
      const { data } = await dailySignsImportData(params, onUploadProgress);
